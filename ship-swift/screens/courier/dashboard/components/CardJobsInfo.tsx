    ...
    const checkJobApplication = async () => {
      if (userId && job) {
        ...
        if (result.success) {
          ...
          console.error("Failed to check job application:", result.error);
        }
      }
    };
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex flex-col">
                {hasApplied ? (
                  <div className="flex items-center justify-start space-x-2 border border-gray-500 bg-gray-100 text-gray-700 px-4 py-2 rounded-md my-2">
