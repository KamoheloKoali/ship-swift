...
import { getDriverByID, updateDriverVerification } from '@/actions/driverActions'
...
export default function DriverPage() {
  ...
  const handleVerify = async (userId: string) => {
    setDriver({ ...driver, isVerified: true })
  ...
  return (
    <>
    {
      isLoading &&  <div className="absolute inset-0 z-50 flex flex-col items-center justify-center bg-white bg-opacity-30 backdrop-blur-md">
      ...
      <Card>
        ...
        {!driver.isVerified && (
          <CardFooter className="flex flex-col sm:flex-row justify-between gap-4">
            ...
            <Button variant="default" onClick={()=>{handleVerify(driver.Id)}} className="w-full sm:w-auto">
      ...
      {!driver.isVerified && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <Card>
            ...
            <CardContent>
              <img src={driver.idPhotoUrl} alt="ID Document" className="w-full h-auto object-cover rounded-md" />
            </CardContent>
          </Card>
          <Card>
            <CardHeader>
            ...
            <CardContent>
              <img src={driver.licensePhotoUrl || '/placeholder.svg'} alt="Driver's License" className="w-full h-auto object-cover rounded-md" />
            </CardContent>
          </Card>
          <Card className="md:col-span-2">
            ...
            <CardContent>
              <img src={driver.discPhotoUrl || '/placeholder.svg'} alt="DISC Photo" className="w-full h-auto object-cover rounded-md" />
            </CardContent>
          </Card>
        </div>
      )}
